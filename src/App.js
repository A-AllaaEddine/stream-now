...
const MovieMeta = lazy(() =>
  import("./routes/movie-meta/movie-meta.component")
);
...
const MediaPlayer = lazy(() =>
  import("./routes/media-player/media-player.component")
);
      ...
      <Suspense>
        <Routes>
          <Route path="/" element={<Navigation />}>
            ...
            <Route path="player/:type/:streamUrl" element={<MediaPlayer />} />
